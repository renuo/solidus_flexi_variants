module SolidusFlexiVariants
  class Engine < Rails::Engine
    ...
    initializer 'spree.flexi_variants.preferences', after: 'spree.environment' do |_app|
      SolidusFlexiVariants::Config = Spree::FlexiVariantsConfiguration.new
    end

    initializer 'spree.flexi_variants.register.line_item_comparision_hooks' do |_app|
